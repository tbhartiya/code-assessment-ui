...
const Tests = () => {
  ...
  return (
    <Box m={5}>
      <PageTitle title={Menus.tests.title} subtitle={Menus.tests.subtitle} />
      <Box container mt={5} className={classes.cardWrapper} spacing={10}>
        <Card
          className={classes.newCard + ' ' + classes.card}
          key={-1 + '-new test'}
        >
